...
class UpdateAmount {
	function Update_Amount($bean,$event,$arguments)
	{
		...
		$product_type =$bean->product_type_c;
		if($product_type!='Savings_Deposits'){
			$bean->product_type_category_2_c='';
			}

		if(($product_type=='Demand_Deposits')||($product_type=='Payfast')||($product_type=='SME_Development_Miscellaneous_Loans')||($product_type=='Leasing')){
			$bean->product_type_category_1_c='';
			}
