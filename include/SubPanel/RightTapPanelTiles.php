...
class RightTapPanelTiles {
    ...
    , $forceTabless = false) {
        ...
        if (empty($_REQUEST['subpanels'])) {
            /*
              BUG FIX: To disbale Grouped Tabs (Subpanel Tabs) Comment this start . By Roshan Sarode 2 Feb 2018
             *  */
            //     $selected_group = $forceTabless?'':$this->getSelectedGroup();
            /*
              BUG FIX: To disbale Grouped Tabs (Subpanel Tabs) Comment this end . By Roshan Sarode 2 Feb 2018
             *  */
        ...
        if ($showContainer) {
            ...
            if (in_array("activities", $tabs) || in_array("history", $tabs)) {
                ...
                echo '</ul>
							...
							<ul class="noBullet" id="subpanel_list_1" >
    ...
    <script>
    	...
    	SUGAR.util.doWhen(
    	    "typeof(SUGAR.subpanelUtils) == 'object' && typeof(SUGAR.subpanelUtils.onDrag) == 'function'" +
    	        " && document.getElementById('subpanel_list_1')",
    	    SubpanelInit
    	);
    </script>
EOQ;
