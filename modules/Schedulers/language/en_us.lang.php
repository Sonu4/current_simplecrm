...
// Messages
    ...
    'LBL_CRON_LINUX_DESC1' => 'In order to run SimpleCRM Schedulers, edit your web server user\'s crontab file with this command: ',
    ...
    'LBL_CRON_WINDOWS_DESC' => 'In order to run the SimpleCRM schedulers, create a batch file to run using Windows Scheduled Tasks. The batch file should include the following commands: ',
