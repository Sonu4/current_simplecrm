...
FROM `aor_reports` JOIN aor_charts ON aor_reports.id = aor_charts.aor_report_id WHERE aor_reports.report_module ='".$module_name."' AND  aor_reports.deleted =0 AND  aor_charts.deleted =0 AND aor_charts.type = 'bar' ORDER BY aor_reports.name";
