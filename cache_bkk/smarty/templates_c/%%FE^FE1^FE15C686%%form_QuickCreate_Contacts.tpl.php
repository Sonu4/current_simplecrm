<?php /* Smarty version 2.6.29, created on 2018-06-25 09:25:33
         compiled from cache/themes/SuiteR/modules/Contacts/form_QuickCreate_Contacts.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteR/modules/Contacts/form_QuickCreate_Contacts.tpl', 62, false),array('function', 'counter', 'cache/themes/SuiteR/modules/Contacts/form_QuickCreate_Contacts.tpl', 68, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/Contacts/form_QuickCreate_Contacts.tpl', 74, false),array('function', 'html_options', 'cache/themes/SuiteR/modules/Contacts/form_QuickCreate_Contacts.tpl', 81, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/Contacts/form_QuickCreate_Contacts.tpl', 107, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteR/modules/Contacts/form_QuickCreate_Contacts.tpl', 75, false),array('modifier', 'lookup', 'cache/themes/SuiteR/modules/Contacts/form_QuickCreate_Contacts.tpl', 298, false),array('modifier', 'count', 'cache/themes/SuiteR/modules/Contacts/form_QuickCreate_Contacts.tpl', 378, false),)), $this); ?>
...
">
<?php if (! empty ( $_REQUEST['contact_id'] )): ?><input type="hidden" name="reports_to_id" value="<?php echo $_REQUEST['contact_id']; ?>
"><?php endif;  if (! empty ( $_REQUEST['contact_name'] )): ?><input type="hidden" name="report_to_name" value="<?php echo $_REQUEST['contact_name']; ?>
"><?php endif; ?>
<div class="action_buttons"><?php if ($this->_tpl_vars['bean']->aclAccess('save')): ?><input title="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_TITLE']; ?>
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_KEY']; ?>
" class="button primary" onclick="var _form = document.getElementById('form_QuickCreate_Contacts'); _form.action.value='Popup';return check_form('form_QuickCreate_Contacts')" type="submit" name="Contacts_popupcreate_save_button" id="Contacts_popupcreate_save_button" value="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
...
addToValidate(\'form_QuickCreate_Contacts\', \'city_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CITY','module' => 'Contacts','for_js' => true), $this); echo '\' );
